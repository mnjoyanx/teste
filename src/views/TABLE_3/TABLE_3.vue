...
const { data, error, loading, get, add, put, remove } = useFetch('admin/table_3');
...
const columns = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      customFilterDropdown: true,
      sorter: () => {},
      sortOrder: sorted.field === 'ascasc' && sorted.order,
      filteredValue: filtered.ascasc || null,
      onFilterDropdownOpenChange: handleFilterDropdownOpenChange
    },
    {
      key: 'actions',
...
<template>
  <div>
    ...
    <div class="table-actions_wrapper">
      ...
      <div>
        <reset-filters :filterState="{ filteredInfo, sortedInfo }" @reset="handleResetFilters" />
      </div>
