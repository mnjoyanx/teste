...
const form = reactive({"ascascasc":""});
const rules = reactive({"ascascasc":[{"required":true,"message":"Please enter ascascasc!"}]});
...
<template>
    <div>
        <a-form :model="form" layout="vertical">
            <a-row :gutter="16">
                <a-col :span="24"> 
        <a-form-item label="ASCASCASC" name="ascascasc" :rules="rules.ascascasc">
          
        <a-input v-model:value="form.ascascasc" />
